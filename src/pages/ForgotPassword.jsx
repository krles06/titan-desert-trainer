        ...
        <div className="min-h-screen bg-dunr-black flex flex-col items-center justify-center px-4 py-8 relative overflow-hidden">
            ...
            <div className="w-full max-w-sm relative z-10">
                <div className="text-center mb-8 sm:mb-10">
                    <div className="inline-flex items-center justify-center w-20 h-14 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm mb-6">
                        <DunrLogo variant="mark" className="w-14" />
                    </div>
